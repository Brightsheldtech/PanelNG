...
// ─── PRODUCT CARD ─────────────────────────────────────────────────────────────
function ProductCard({ listing, onClick, exchangeRate = 2900 }) {
...
// ─── DETAIL SHEET ─────────────────────────────────────────────────────────────
function DetailSheet({ listing, detail, detailLoading, onClose, balance, onBuy, exchangeRate = 2900 }) {
...
// ─── PURCHASE MODAL ───────────────────────────────────────────────────────────
function PurchaseModal({ listing, qty, balance, onClose, onSuccess, onAddFunds, token, exchangeRate = 2900 }) {
...
export default function BuyAccounts({ balance = 0, token = '', onNavigate, onPurchaseComplete }) {
  ...
  const [exchangeRate, setExchangeRate] = useState(2900);
