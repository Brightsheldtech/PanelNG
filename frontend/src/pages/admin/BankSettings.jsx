...
export default function BankSettings() {
  ...
  const [settings, setSettings] = useState({ admin_email: '', gmail_user: '', usd_ngn_rate: '1600' });
  ...
  useEffect(() => {
    Promise.all([api.get('/admin/bank-details'), api.get('/admin/settings')])
      .then(([bankRes, settingsRes]) => {
        ...
        setSettings({ admin_email: s.admin_email || '', gmail_user: s.gmail_user || '', usd_ngn_rate: s.usd_ngn_rate || '1600' });
      })
