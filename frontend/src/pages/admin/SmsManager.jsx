...
function CountryRow({ country, serviceCode, onUpdated, rate }) {
  ...
  const toNgn = (usd) => Number(usd || 0) * Number(rate || 1600);
    ...
    <>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14, flexWrap: 'wrap' }}>
        ...
        <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 8 }}>
          <span style={{ fontSize: 11, color: 'var(--text-dim)', fontFamily: 'var(--font-mono)' }}>₦{Number(rate || 1600).toLocaleString()}/$1</span>
